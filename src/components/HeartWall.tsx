...
import { Heart, User, X, Calendar, MapPin, MessageCircle } from 'lucide-react';
...
export function HeartWall({ couples, loading }: HeartWallProps) {
  ...
  const heartPoints = useMemo(() => {
    return generateHeartPoints(centerX, centerY, size);
  ...
  useEffect(() => {
    const updateSize = () => {
      ...
      const newSize = isMobile ? 400 : 800;
      setSize(newSize);
  ...
  const handleTileClick = (couple: Couple) => {
  ...
  return (
    <div className="text-center">
      ...
      <div className="relative mx-auto" style={{ width: size, height: size }}>
        ...
        <div className="relative w-full h-full">
          {heartPoints.map((point, index) => {
            const couple = index < approvedCouples.length ? approvedCouples[index] : null;
                ...
                {couple ? (
                  <div className="relative w-full h-full group cursor-pointer">
                    ...
                    <div 
                      ...
                      style={{
                        backgroundImage: `url(${couple.thumbUrl})`,
                      }}
                    />
                    ...
                    {isHovered && (
                      <motion.div
                        ...
                        className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-xl p-3 border border-pink-200 min-w-max"
                      >
                        <div className="text-center">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
        ...
        <div className="text-center">
          <div className="text-3xl font-bold text-pink-600">
            {(10000 - filledTiles).toLocaleString()}
          </div>
          <div className="text-sm text-gray-600">Spots Left</div>
        </div>
        <div className="text-center">
          <div className="text-3xl font-bold text-pink-600">
            {Math.round((filledTiles / 10000) * 100)}%
          </div>
                  ...
                  {selectedCouple.country && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-800">{selectedCouple.country}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {selectedCouple.story && (
                    <div className="md:col-span-2">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-600 mb-2">Love Story</p>
                          <p className="text-gray-800 leading-relaxed">{selectedCouple.story}</p>
                        </div>
                      </div>
                    </div>
                  )}
